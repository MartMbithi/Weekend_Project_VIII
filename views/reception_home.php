                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle text-center">
                                                                        <a data-toggle="modal" href="#update_<?php echo $patients['user_id']; ?>" class="badge badge-warning">
                                                                            <i class="fa fa-user-edit"></i> Edit
                                                                        </a>
                                                                        <a data-toggle="modal" href="#add_test_<?php echo $patients['user_id']; ?>" class="badge badge-success">
                                                                            <i class="fa fa-file-prescription"></i> Add Lab Test
                                                                        </a>
                                                                ...
                                                                <!-- Add Testst -->
                                                                <div class="modal fade fixed-right" id="add_test_<?php echo $patients['user_id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                                    <div class="modal-dialog  modal-xl" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header align-items-center">
                                                                                <div class="modal-title">
                                                                                            ...
                                                                                            <select type="text" required name="patient_test_done_by" class="form-control">
                                                                                                ...
                                                                                                if (mysqli_num_rows($technician_sql) > 0) {
                                                                                                    while ($technicians = mysqli_fetch_array($technician_sql)) { ?>
                                                                                                        <option value="<?php echo $technicians['user_id']; ?>"><?php echo $technicians['user_number'] . ' ' . $technicians['user_full_names']; ?></option>
                                                                                                <?php }
                                                                                                } ?>
                                                                                            </select>
                                                                                        </div>
