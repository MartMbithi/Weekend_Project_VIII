                            ...
                            <header class="page-title-bar">
                                <div class="d-flex flex-column flex-md-row">
                                    ...
                                    <div class="ml-auto">
                                        <!-- .dropdown -->
                                        <div class="dropdown">
                                            <button type="button" data-toggle="modal" data-target="#add_modal" class="btn btn-secondary"><span>Register Chief Lab Technician</button>
                                        </div><!-- /.dropdown -->
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header align-items-center">
                                            <div class="modal-title">
                                                <h6 class="mb-0">Register New Chief Lab Technician</h6>
                                            </div>
                                            ...
                                            <form method="post" enctype="multipart/form-data" role="form">
                                                <div class="row">
                                                    <div class="form-group col-md-8">
                                                        ...
                                                        <input type="hidden" required name="user_access_level" value="Chief Lab Technician" class="form-control">
                                                ...
                                                <div class="text-right">
                                                    <button type="submit" name="Add_User" class="btn btn-primary">Register Chief Lab Technician</button>
                                                </div>
                                                <br>
                                            </form>
                                        </div>
